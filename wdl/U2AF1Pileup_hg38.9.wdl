...
####################################################################################
# Required 
    # 1. U2AF1 intervals: whole gene "chr21:6484023-6499848,chr21:43092356-43108170" 
    # ## only hotspot mutations: *list
    # 2. bcftools docker e.g. mmuddin2020/bcftools:1.13
    # 3. Reference fasta, fai and dict
    # 4. Bam file
################################################################################### 
#### U2AF1 hotspot mutations
# Q157P:chr21:6486334-6486334
# Q157P:chr21:43094667-43094667
# Q157R:chr21:6486334-6486334
# Q157R:chr21:43094667-43094667
# R156H:chr21:6486337-6486337
# R156H:chr21:43094670-43094670
# S34F:chr21:6496024-6496024
# S34F:chr21:43104346-43104346
# S34Y:chr21:6496024-6496024
# S34Y:chr21:43104346-43104346
##########################################
...
workflow GetU2AF1Pileup {
  input {
    ...
    String U2AF1_hoptspot_mutations = "chr21:6486334-6486334,chr21:6486337-6486337,chr21:6496024-6496024,chr21:43094667-43094667,chr21:43094670-43094670,chr21:43104346-43104346"
    
    String bcftools_docker = "mmuddin2020/bcftools:1.13"
 ...
 call U2AF1Pileup{
      ...
      input_bam = bam,
      input_bai = bai,
      U2AF1_hoptspot_mutations = U2AF1_hoptspot_mutations,
      ref_fasta = ref_fasta,
      ref_fai = ref_fai,
      ref_dict = ref_dict,
      is_bam = is_bam,
...
task U2AF1Pileup {
  input {
    ...
    File input_bam
    File input_bai
    String U2AF1_hoptspot_mutations
    File ref_fasta
    File ref_fai
    File ref_dict
    Boolean is_bam
